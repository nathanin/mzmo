...
function varargout = extract_m0(varargin)
	%rootdir = varargin{1};
	%writep = varargin{2};
    %writeLL = varargin{3};
    ...
    rootdir = '/home/ingn/mzmo/data/nuclei/source_nuclei_0';
    writep = '/home/ingn/mzmo/data/nuclei/indiv.fixed64.pick20.nodilate/0';
    writeLL = '/home/ingn/mzmo/data/nuclei/indiv.fixed64.pick20.nodilate/LL0';
